            ...
            .pipe(
                ...
                catchError((err: any) => {
                    ...
                    if (err.code === "ECONNREFUSED") {
                        errorMessage = `Server Not Accessible. Please make sure commander is online.`;
                        ...
                        errorMessage = `Unable to login to selected commander ${code}. Please make sure the selected commander is online and accessible`;
                        growlerData = new GrowlerModel(
                            'error',
                            'Error',
                            `Login Failed`,
