...
export class JwtSignersPageService extends ListPageServiceClass {

    private paging = this.DEFAULT_PAGING;

    resourceType = 'external-jwt-signers';
    selectedConfig: any = {};
    modalType = '';
    ...
    initTableColumns(): any {
        ...
        const enabledHeaderComponentParams = {
            filterType: 'SELECT',
            enableSorting: true,
            filterOptions: [
                { label: 'All', value: '' },
        ...
        return [
            ...
            },
            {
                ...
                headerName: 'Enabled',
                headerComponent: TableColumnDefaultComponent,
                headerComponentParams: enabledHeaderComponentParams,
                resizable: true,
                cellClass: 'nf-cell-vert-align tCol',
                sortable: true,
                filter: true,
    ...
    getData(filters?: FilterObj[], sort?: any, page?: any) {
        ...
        return super.getTableData('jwt-signers', paging, filters, sort)
            .then((results: any) => {
